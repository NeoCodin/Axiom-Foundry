...
2. Enter Pelagos orbit with the familiar Ark, Foundry, and permanent Continuity destinations. Rebuild the receiver, prepare the habitat, authorize the SOS carrier, listen, and rescue the first witnesses one step at a time. Personnel then opens as a roster before its support, command, medical, and expedition systems are introduced.
