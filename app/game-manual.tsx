...
export const MANUAL_TOPICS: Record<ManualTopicId, ManualTopic> = {
  ...
  "cultural-records": {
    ...
    steps: [
      ...
      { title: "Staff education and analysis", detail: "On-duty Teacher and Researcher levels grow the archive. Population adds a small background flow, but expertise matters more than headcount." },
      { title: "Transfer it", detail: "Press +25 in Evidence Reservoirs to move Ark Supply into the Lattice." },
    ],
  },
  schematics: {
