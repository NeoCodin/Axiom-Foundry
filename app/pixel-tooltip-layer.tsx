...
const TOOLTIP_RULES: TooltipRule[] = [
  ...
  { selector: ".research-stage-thresholds > div", copy: "Research threshold. Evidence crosses Theory, Prototype, Field Validation, and Final Synthesis in order. The illuminated gate is the stage currently being solved." },
  ...
  { selector: ".research-analysis-head", copy: "Live analysis head. Evidence packets converge here, and the head advances across the void as the project crosses each research threshold. Select it to inspect the detailed Lattice." },
  { selector: ".research-field-legend > span", copy: "Evidence color key. Lit entries are flowing into this project; red entries identify an exhausted evidence source holding the project." },
