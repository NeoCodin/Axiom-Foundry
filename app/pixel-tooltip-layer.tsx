...
const TOOLTIP_RULES: TooltipRule[] = [
  ...
  { selector: ".research-core-node", copy: "Analysis Core. Evidence flows into this project-colored machine only while research is progressing. Select it to inspect the detailed Lattice." },
