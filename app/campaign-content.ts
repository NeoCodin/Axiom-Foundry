...
export const CAMPAIGN_WORLDS: readonly CampaignWorldDefinition[] = [
  {
    ...
    infrastructure: [
      {
        id: "stabilize-containment-law",
        name: "Prove Containment",
        description: "Forge the first Axiom so the Ark can hold atmosphere and heat through a reset.",
      },
      {
        id: "stabilize-conservation-law",
        name: "Prove Conservation",
        description: "Forge a second Axiom so stored matter remains itself during Pelagos approach.",
      },
      {
        id: "stabilize-transit-law",
        name: "Prove Transit",
        description: "Forge a third Axiom so the Ark can carry a stable local reality into orbit.",
      },
    ],
    roleRequirements: [],
