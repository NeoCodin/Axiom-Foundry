...
export const RESEARCH_PROJECT_DEFINITIONS: readonly ResearchProjectDefinition[] = [
  ...
  },
  {
    ...
    completedSummary: "Every landing now improves the Ark's planetary map instead of becoming an isolated report.",
    workRequired: 2_400,
  ...
  },
  {
    ...
    summary: "Standardize equipment frames around measured failure instead of copied blueprints.",
  ...
  },
  {
    ...
    summary: "Treat equipment modifications as mission doctrine rather than personal inventory clutter.",
  ...
  },
  {
    ...
    completedSummary: "Restored settlements can establish resilient ecologies instead of isolated life-support loops.",
    workRequired: 12_500,
  ...
  },
  {
    ...
    contradiction: "THE WEAPON IS NOT RECOGNIZING ITS CARRIER. IT IS RECOGNIZING A LATER VERSION.",
    workRequired: 13_500,
  ...
  },
  {
    ...
    nullEcho: "THE INVASION FLEET IS NOT APPROACHING. IT IS REMEMBERING THE ROUTE BACK.",
  },
  {
  ...
  },
  {
    ...
    summary: "Map hostile routes by the futures they connect instead of the distance they cross.",
  ...
  },
  {
    ...
    summary: "Return settlement results to the Ark instead of treating departure as the end of a world's research.",
