...
export const CONTACT_CLASSIFICATIONS: readonly ContactClassificationDefinition[] = [
  ...
  },
  {
    ...
    code: "RV-01",
    threshold: 4,
    summary: "The contacts do not merely travel quickly. Their effects repeatedly arrive before their local causes.",
...
export const CAUSAL_EVIDENCE_DEFINITIONS: readonly CausalEvidenceDefinition[] = [
  ...
  { id: "def-returned-navigation", source: "ark-defense", sourceId: "returned-navigation", title: "Origin charts", finding: "Restored worlds are labeled causal origins rather than targets." },
  ...
  { id: "research-threat", source: "research", sourceId: "causal-threat-projection", title: "Interdiction model", finding: "Attacks correlate with future possibility rather than present military value." },
  ...
  { id: "research-cartography", source: "research", sourceId: "causal-cartography", title: "Causal cartography", finding: "Enemy routes connect possible futures, not physical distance." },
  { id: "research-returned", source: "research", sourceId: "returned-origin-hypothesis", title: "Returned hypothesis", finding: "The strongest model places the contacts downstream of restored life. It is not proof." },
  ...
  { id: "expedition-palimpsest", source: "expedition", sourceId: "palimpsest-origin", title: "Palimpsest coordinate", finding: "The oldest Foundry coordinate points to something overwritten rather than destroyed." },
